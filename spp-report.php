...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-7">
        <div class="card-deck">
            <div class="card bg-light pointer" onclick="document.location.href='income-spp.php'">
                <div class="card-body text-center">
                    <i class="fas fa-file-alt display-1 text-primary"></i>
                </div>
                <div class="card-footer">
                    <p class="card-text">LAPORAN PENDAPATAN SPP</p>
                </div>
            </div>
            <div class="card bg-light pointer" onclick="document.location.href='spp-report.php'">
                ...
                <div class="card-footer">
                    <p class="card-text">LAPORAN TUNGGAKAN SPP</p>
                </div>
            </div>
        </div>
    </div>
